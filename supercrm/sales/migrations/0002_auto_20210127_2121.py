# -*- coding: utf-8 -*-
# Generated by Django 1.11.9 on 2021-01-27 13:21
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('birthday', models.DateField(default=None, help_text='格式yyyy-mm-dd', verbose_name='出生日期')),
                ...
                ('status', models.CharField(choices=[('signed', '已报名'), ('unregistered', '未报名'), ('studying', '学习中'), ('paid_in_full', '学费已交齐')], default='unregistered', help_text='选择客户的状态', max_length=64, verbose_name='状态')),
